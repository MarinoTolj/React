        ...
        <div>
            ...
            <Form id="create-exercise-form">
                <Form.Group>
                    ...
                    <Form.Control type="text" placeholder="Add type to your new exercise" onChange={(e)=>setType(e.target.value)}/>
                </Form.Group>
                <Form.Group>
                    <Form.Label htmlFor="img">Select Image</Form.Label>
                    <Form.Control type="file" accept="image/*" onChange={handleCreate}/>
                </Form.Group>
                <Button variant="primary" type="sumbit" onClick={handleRoute}>Create</Button>
            </Form>
        </div>
    )
}
